...
def dm_format_osd(filename):
    ...
    with pd.ExcelWriter(output_file , engine="xlsxwriter") as writer:
        ...
        dom_osd_3000_10_months[columns].to_excel(writer, sheet_name = 'dom_3000_10_months' , startrow = 0 , index = False)
        ...
        comm_osd_3000_4_months[columns].to_excel(writer, sheet_name= 'comm_3000_4_months', startrow= 0 , index = False)
